...
public class AcquisitionAPI {
    ...
    public AcquisitionAPI(CollectionService collectionService, DeviceManager deviceManager, DataCollector dataCollector, IAnalysisService analysisService) {
    ...
    /**
     * Zwraca listę dostępnych urządzeń w formacie czytelnym dla interfejsu użytkownika.
     *
     ...
     * @return Wartość odczytu lub null, jeśli urządzenie nie istnieje lub wystąpił błąd.
     */
     ...
     * Może być wykorzystywane przez administratora do odświeżenia całego stanu systemu.
     */
    public void requestAllData() {
        collectionService.forceRead();
    }

    public void startPeriodicCollectionTask(){ collectionService.runPeriodicCollectionTask();}
