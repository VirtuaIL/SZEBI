error id: file://<WORKSPACE>/analysis-report/src/main/java/org/example/App.java
file://<WORKSPACE>/analysis-report/src/main/java/org/example/App.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[7,3]

error in qdox parser
file content:
```java
offset: 68
uri: file://<WORKSPACE>/analysis-report/src/main/java/org/example/App.java
text:
```scala
package org.example;
...
QDox parse error in file://<WORKSPACE>/analysis-report/src/main/java/org/example/App.java